...
export const alt =
  "dynvon — Automatisierung für Gebäudereinigungsunternehmen";
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "10px" }}>
              ...
              <span>vergessene Mahnungen</span>
            </div>
            <div style={{ display: "flex", alignItems: "baseline", gap: "10px" }}>
              <span
                style={{
